const QUIZ_SECTIONS = document.querySelectorAll(".quiz-section"); //Section list elements
...
//print question on web page
const QUESTION_1 = new Question("What does HTML stand for? ", 
  ["Hyper Tag Markup Language", "Hyper Text Markup Language", "Hyperlinking Text Marking Language", "Hyperlinks Text Mark Language"], 1);
const QUESTION_2 = new Question("How can you open a link in a new browser window?", 
  ["A href='url' target='_blank'", "A href='url' new", "A href='url' target='new'", "A href='url' target='_window'"], 0);
const QUESTION_3 = new Question("Which is the correct way to write a comment in JavaScript?", 
  ["{# ... #}", "<!---....---!>", "// ...", "\\ ..."], 2);
const QUESTION_4 = new Question("How do you write 'Hello World' in an alert box?", 
  ["alert('Hello World')", "msg('Hello World')", "msgBox('Hello World')", "alertBox('Hello World')"], 0);
const QUESTION_5 = new Question("How do you create a function in JavaScript?", 
  ["function = myFunction()", "function myFunction()", "function : myFunction()", "function - myFunction()"], 1);
